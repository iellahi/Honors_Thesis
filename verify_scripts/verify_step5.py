...
Verifies: the Bellmans/FOCs/BR roots; the compact BR quadratics; unique-positive-root
selection; value ordering lemma; Prop. 3 analytical chain (mu = lam).

Thesis: Section 4.2 and Appendix C.1, the best-response quadratics.
"""
import sympy as sp
...
print("="*70)
print("A4: the explicit BR roots solve the quadratics; additive root is the")
