...
Thesis: Appendix B.2, the effort comparative statics (Proposition 1).
"""
import sympy as sp
...
print("         (this is the 'verify denominator negative' step)")
print("="*70)
F_x = sp.diff(F, x)
...
print("="*70)
print("CHECK 4: dx*/dlam > 0 UNDER (A2) -- strengthens the 12c>W condition")
print("="*70)
F_lam = sp.diff(F, lam)
print("F_lam =", sp.expand(F_lam))
# F_lam = c(1+b)x^2 - 2 lam W(1-b^2) x + 2W(1-b)
# Claim: F_lam > 0 whenever 3c > lam^2 W (1-b^2)  [the auxiliary condition]
