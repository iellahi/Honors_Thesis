...
Independent rebuild of results (R1)-(R4): every identity is re-derived from
the best-response quadratics rather than assumed.
...
Thesis: Section 5.5 and Appendix C.5.
"""
import sympy as sp
