...
Outputs: numerics/task6_confirmation.txt  (raw confirmation tables)

Thesis: Section 5.2 (confirmation battery) and Section 5.3 (break regions).
"""
...
# task6_diagnose_signs.py re-solves every flagged case at 50 digits.  Any other row
...
if nflag:
    ...
    log( "     derivatives, adjudicated at 50 digits by task6_diagnose_signs.py.")
