...
Pointwise claims:  (1,1) interiority & prob; value ordering; V11<W/2; Prop. 3 (mu=lam slice);
...
rows = [
 ...
 ("Prop. 3: z*>x* at mu=lam", "T-cross", psym+fsym, fsym, f"{fsym} fails"),
