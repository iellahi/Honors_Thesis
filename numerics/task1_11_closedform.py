...
No SciPy dependency; the root-finders are hand-rolled so the check is independent.
...
Thesis: Section 4.1 and Appendix A (the (1,1) closed form); Section 5.3 (corner regime).
"""
