"""
Diagnostic for the seed-707 scan (task6_seed707.py): are the Prop. 2 / Prop. 4
sign "failures" real, or finite-difference
...
Thesis: Section 5.2, the 50-digit adjudication of finite-difference flags.
"""
import math, random
import mpmath as mp
mp.mp.dps = 50
...
print(f"Prop. 2 (V11 signs): float-flagged {p1p_flag}, HIGH-PRECISION real violations {p1p_realbad}")
for ex in p1p_examples: print("   ", ex)
print(f"Prop. 4  (x00 signs): float-flagged {p3_flag}, HIGH-PRECISION real violations {p3_realbad}")
