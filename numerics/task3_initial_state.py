...
Plus the internal-consistency check behind Prop. 4's *unconditional* dx00*/dV10:
...
Thesis: Section 4.3 and Appendix D; early-effort signs are Proposition 4.
"""
...
log("")
log("="*74)
log("PART B: Prop. 4 consistency -- exact identity & m x00* < 1-b0 frequency")
...
if fail == 0 and max_F00_at_pt < 0:
    ...
    log("   unconditionally (matches finalized Prop. 4; not merely the raw partial).")
else:
